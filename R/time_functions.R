...
#'
#' Computes cumulative distribution (capgt), density (gt), and hazard (ht) for
#' the generalized temporal decomposition model parameterized by half-life,
#' exponent nu (eta), and shape m (gamma).
#'
...
#' @param complet Integer flag for complete (1) vs incomplete (0) distribution (currently unused).
#' @return A list with components: capgt (cumulative), gt (density/early phase), ht (hazard/late phase).
#' @details
